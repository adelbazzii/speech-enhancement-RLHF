...
def main():
    ...
    parser.add_argument(
        "--exp_name", type=str, default="exp1", help="name of the experiment"
    )
    parser.add_argument("--device", type=str, default="cuda", help="Gpu device")
    parser.add_argument(
        "--output_path", type=str, default="results", help="Model and Log path"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--target_metric", type=str, default="pesq", help="pesq or csig or cbak or covl"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.2,
        help="history portion of replay buffer",
    )
    parser.add_argument("--lr", type=float, default=5e-4)
    parser.add_argument("--eval_per_epoch", type=int, default=1)
    parser.add_argument(
        "--skip_val_epoch", type=int, default=600, help="skip early epoch evaluation"
    )
    ...
    parser.add_argument(
        ...
        nargs="*",
        default=[],
        help="select validation speaker (e.g., p226, p227, ..., etc)",
    )
